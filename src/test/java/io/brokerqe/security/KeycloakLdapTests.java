...
public class KeycloakLdapTests extends LdapTests {
    ...
    private final String testNamespace = getRandomNamespaceName("kc-ldap-tests", 6);
    ...
    public void setupEnvironment() {
        CertificateManager.createBrokerTruststoreSecretWithOpenshiftRouter(getClient(), testNamespace, brokerTruststoreSecretName, brokerTruststoreFileName);
