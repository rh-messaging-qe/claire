...
public class CertificateManager {
    ...
    public static final String DEFAULT_BROKER_ALIAS = "brokerUser";
    public static final String DEFAULT_BROKER_PASSWORD = "brokerPass";
...
//            keystores.put(keyStoreDataName, new KeyStoreData(clientKeyStore, keyStoreFileName, keyStoreDataName, keystorePassword, certificateData));
    ...
    public static Map<String, String> createKeystoreSecret(Map<String, KeyStoreData> keystores, String alias) {
    ...
    public static Map<String, String> createClientKeystoreSecret(Map<String, KeyStoreData> keystores) {
        ...
        return clientTlsSecret;
    }

    public static Map<String, String> createBrokerKeystoreSecret(Map<String, KeyStoreData> keystores) {
        ...
        return brokerTlsSecret;
    }

    public static Map<String, String> createConsoleKeystoreSecret(Map<String, KeyStoreData> keystores) {
