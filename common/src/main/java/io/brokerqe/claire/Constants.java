...
public interface Constants {
    ...
    String EV_OLM_RELEASED = "OLM_RELEASED";
    ...
    String EV_PACKAGE_MANIFEST = "PACKAGE_MANIFEST";
    String EV_LOGS_LOCATION = "LOGS_LOCATION";
    String EV_TMP_LOCATION = "TMP_LOCATION";
    String EV_TEST_FAIL_ABORT_COUNT = "TEST_FAIL_ABORT_COUNT";
    ...
    String EV_JOLOKIA_API_URL = "JOLOKIA_API_URL";
    String EV_SPP_URL = "SPP_URL";
    ...
    long DURATION_90_SECONDS = Duration.ofSeconds(90).toMillis();
...
//    String IMAGE_OPENLDAP = "docker.io/bitnami/openldap:latest";
    // To be mirrored!
    String IMAGE_OPENLDAP = "quay.io/rhmessagingqe/openldap:2.6.7";
    String IMAGE_POSTGRES = "quay.io/rhmessagingqe/postgresql:latest";
    String IMAGE_MYSQL = "quay.io/rhmessagingqe/mysql:latest";
    String IMAGE_MARIADB = "quay.io/rhmessagingqe/mariadb:latest";
