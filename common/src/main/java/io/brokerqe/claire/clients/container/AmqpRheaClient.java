...
public class AmqpRheaClient extends SystemtestClient {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AmqpRheaClient.class);

    String getCliExecutableBase() {
        return "cli-rhea";
    }

    public AmqpRheaClient(DeployableClient deployableClient, String destinationUrl, String destinationPort, String address, String queue, int messageCount) {
    ...
    public AmqpRheaClient(DeployableClient deployableClient, String destinationUrl, String destinationPort, String address, String queue, int messageCount, String username, String password) {
        String brokerUri = String.format("amqp://%s:%s", destinationUrl, destinationPort);
        String fqqn = String.format("%s::%s", address, queue);
        Map<String, String> senderOptions = new AmqpCliOptionsBuilder()
                .address(fqqn)
    ...
    public AmqpRheaClient(DeployableClient deployableClient, String brokerUri, String address, String queue, int messageCount, String saslMechanism, String keystore, String keystorePassword, String trustStore, String trustStorePassword) {
    ...
    public AmqpRheaClient(DeployableClient deployableClient, String brokerUri, Map<String, String> senderOptions, Map<String, String> receiverOptions) {
        this.deployableClient = deployableClient;
        this.brokerUri = brokerUri;
        this.senderOptions = senderOptions;
        this.receiverOptions = receiverOptions;
    ...
    public AmqpRheaClient(DeployableClient deployableClient, String brokerUri, Map<String, String> senderOptions, Map<String, String> receiverOptions, boolean secured) {
        this.deployableClient = deployableClient;
        this.brokerUri = brokerUri;
        this.senderOptions = senderOptions;
        this.receiverOptions = receiverOptions;
