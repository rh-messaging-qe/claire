...
public class SystemTestProtonDotnetClientContainer extends AbstractGenericContainer {

    private static final Logger LOGGER = LoggerFactory.getLogger(SystemTestProtonDotnetClientContainer.class);

    public SystemTestProtonDotnetClientContainer(String name) {
        super(name, ENVIRONMENT_STANDALONE.getSystemtestCliProtonDotnet());
