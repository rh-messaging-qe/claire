...
| RAPIDAST_SA_FILE              | Keyfile for RapiDast results report             | not set                                                | \<directory\>                                    |
...
**_NOTE:_** `rapidast.sa.file | RAPIDAST_SA_FILE` obtained from Security team, is used to upload DAST results here: https://console.cloud.google.com/storage/browser/secaut-bucket/amq-broker
